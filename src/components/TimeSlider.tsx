...
const TimeSlider = memo(({ onPeriodChange, onPanToEvent, selectedYear }: TimeSliderProps) => {
  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-90 p-4 rounded-lg shadow-lg z-10">
      <div className="mb-2">
        <h2 className="text-xl font-bold text-gray-800">{selectedPeriod.label} ({selectedPeriod.year})</h2>
