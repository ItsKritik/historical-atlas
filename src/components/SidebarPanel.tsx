...
const SidebarPanel = ({ title, children, initialCollapsed = false, initialPosition = { x: 0, y: 0 }, timeSliderHeight = 0 }: SidebarPanelProps) => {
  ...
  return (
    <div
      ref={panelRef}
      className="bg-white bg-opacity-90 dark:bg-gray-800 dark:bg-opacity-90 p-4 rounded-lg shadow-lg mb-4 cursor-grab sidebar-panel"
      style={{
        position: 'absolute',
      ...
      {!isCollapsed && (
        <div className="mt-2">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <h3 className="font-semibold text-sm text-gray-800 dark:text-gray-100">Ваш прогресс:</h3>
